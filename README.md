...
**[jaafarsleiman.com](https://jaafarsleiman.com)** · live · [source](https://github.com/ahmadtsleima/jaafar_por)
...
**Backend** — Python · Django · REST APIs · authentication & authorisation · JWT · bcrypt · Node.js · Express

**AI** — LLM integration · prompt design and constraint · conversational systems

**Infrastructure** — Docker · Cloudflare Workers · Railway · Fly.io · Vercel

**Also comfortable in** — React · JavaScript · Vite · Three.js / WebGL
